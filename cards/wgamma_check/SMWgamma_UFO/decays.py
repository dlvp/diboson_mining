...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.W__minus__,P.W__plus__):'(((-12*cw**2*ee**2*MW**2)/sw**2 - (17*cw**2*ee**2*MZ**2)/sw**2 + (9*CPWWWL2**2*cw**2*ee**2*MZ**2)/(2.*sw**2) - (9*cw**2*CWWWL2**2*ee**2*MZ**2)/sw**2 + (4*cw**2*ee**2*MZ**4)/(MW**2*sw**2) + (3*CPWWWL2**2*cw**2*ee**2*MZ**4)/(4.*MW**2*sw**2) - (30*cw**2*CWWWL2*ee**2*MZ**4)/(MW**2*sw**2) + (27*cw**2*CWWWL2**2*ee**2*MZ**4)/(4.*MW**2*sw**2) + (cw**2*ee**2*MZ**6)/(4.*MW**4*sw**2) - (11*CPWWWL2**2*cw**2*ee**2*MZ**6)/(8.*MW**4*sw**2) + (15*cw**2*CWWWL2*ee**2*MZ**6)/(2.*MW**4*sw**2) - (81*cw**2*CWWWL2**2*ee**2*MZ**6)/(8.*MW**4*sw**2) + (CPWWWL2**2*cw**2*ee**2*MZ**8)/(4.*MW**6*sw**2) + (9*cw**2*CWWWL2**2*ee**2*MZ**8)/(4.*MW**6*sw**2))*cmath.sqrt(-4*MW**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)'})
