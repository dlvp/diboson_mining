...
C     
C     Process: u d~ > a e+ ve NP<=99 QCD<=99 QED<=99 @1
C     Process: u d~ > a mu+ vm NP<=99 QCD<=99 QED<=99 @1
C     Process: u s~ > a e+ ve NP<=99 QCD<=99 QED<=99 @1
C     Process: u s~ > a mu+ vm NP<=99 QCD<=99 QED<=99 @1
C     Process: c d~ > a e+ ve NP<=99 QCD<=99 QED<=99 @1
C     Process: c d~ > a mu+ vm NP<=99 QCD<=99 QED<=99 @1
C     Process: c s~ > a e+ ve NP<=99 QCD<=99 QED<=99 @1
C     Process: c s~ > a mu+ vm NP<=99 QCD<=99 QED<=99 @1
C     Process: d u~ > a e- ve~ NP<=99 QCD<=99 QED<=99 @1
C     Process: d u~ > a mu- vm~ NP<=99 QCD<=99 QED<=99 @1
C     Process: d c~ > a e- ve~ NP<=99 QCD<=99 QED<=99 @1
C     Process: d c~ > a mu- vm~ NP<=99 QCD<=99 QED<=99 @1
C     Process: s u~ > a e- ve~ NP<=99 QCD<=99 QED<=99 @1
C     Process: s u~ > a mu- vm~ NP<=99 QCD<=99 QED<=99 @1
C     Process: s c~ > a e- ve~ NP<=99 QCD<=99 QED<=99 @1
C     Process: s c~ > a mu- vm~ NP<=99 QCD<=99 QED<=99 @1
C     
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u d~ > a e+ ve
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u s~ > a e+ ve
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! c d~ > a e+ ve
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! c s~ > a e+ ve
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! d u~ > a e- ve~
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! d c~ > a e- ve~
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! s u~ > a e- ve~
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! s c~ > a e- ve~
      ENDIF
